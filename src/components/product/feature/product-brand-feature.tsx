...
const ProductBrandFeature = () => {
  const brand_products = [...product_data].filter(p => p.brand === 'Madhuban Foods');
  return (
            ...
            <div className="col-lg-3">
              <div className="tpbrandproduct__main text-center">
                ...
                <div className="tpbrandproduct__main-contetn">
                  <h4 className="tpbrandproduct__title">Premium Dry Fruits</h4>
                  <p>Discover handpicked, nutrient-rich dry fruits packed with natural flavor and energy for your healthy lifestyle.</p>
