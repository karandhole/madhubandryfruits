                  ...
                  <div className="header__for-megamenu p-relative">
                     <div className="row align-items-center">
                        ...
                        <div className="col-xl-5">
                           <div className="header__menu main-menu text-end">
                              <Menus position="left" />
                           </div>
                        </div>
                        ...
                        {/* RIGHT MENU + ICONS */}
                        <div className="col-xl-5 d-flex justify-content-between align-items-center">
                           <div className="header__menu main-menu text-start">
                              <Menus position="right" />
                           </div>
