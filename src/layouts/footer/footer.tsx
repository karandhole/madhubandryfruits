                  ...
                  <div className="row">
                     <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div className="tpfooter__widget footer-col-1 mb-50">
                           ...
                           <p>If you have any question, please <br /> contact us at:
                              <a href="mailto:support@example.com">support@madhubanstore.com</a>
                           </p>
                     ...
                     <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div className="tpfooter__widget footer-col-2 mb-50">
                           <h4 className="tpfooter__widget-title">Looking for Dryfruits?</h4>
                           <p>68 St. Vicent Place, Glasgow, Greater <br /> Mumbai, MAaharashtra</p>
                  ...
                  <div className="row">
                     <div className="col-lg-6 col-md-7 col-sm-12">
                        <div className="tpfooter__copyright">
                           <span className="tpfooter__copyright-text">Copyright © <a href="#">MADHUBAN</a> all rights reserved. Powered by <a href="#">Madhuban Store</a>.</span>
                        </div>
                     </div>
